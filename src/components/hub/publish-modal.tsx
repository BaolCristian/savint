        ...
        {(!link || revoked || reauthUrl) ? (
          ...
          <div className="space-y-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700"
            >
              {t("openOnSavint")} ↗
            </a>
            <p className="break-all text-xs text-slate-400">{successUrl}</p>
            <div className="flex justify-end">
              <button
                type="button"
                onClick={onClose}
                className="rounded px-4 py-1.5 text-sm font-semibold text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
              >
                {t("done")}
              </button>
            </div>
